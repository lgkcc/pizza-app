...
const NotEmptyCart: React.FC<NotEmptyCartProps> = ({countItems}) => {
    ...
    return (
        <div className="cart">
            <div className="cart__top">
                ...
                <div className="cart__clear" onClick={() => dispatch(removeAllItems())}>
            ...
            <div className="content__items">
                {
                    items.map((item) => <Item key={item.cartId} {...item}/>)
                }
            </div>
